public class MyUnionFind {
    ...
    // REMOVE THESE METHODS IF IT DOESNT WORK...
    public void resetParentIdAndSize(int atIndex){
        //StdOut.println("Reseting");
        parent[atIndex] = atIndex;
        size[atIndex] = 1;
    }

    public void resetCountAndMaxComponentSize(int N){
        count = N;
        maxComponentSize = 0;
    }
    ...
    public int getSizeNumber(int index){
        return size[index];
    }
    // REMOVE TO HERE...
